...
public:
    ...
    explicit Storage(QObject* parent, QHash<mediaelch::scraper::MovieScraperInterface*, QString> ids);
    ...
    QHash<mediaelch::scraper::MovieScraperInterface*, QString> ids() const;
    ...
    static QVariant toVariant(QObject* parent, QHash<mediaelch::scraper::MovieScraperInterface*, QString> ids);
...
private:
    ...
    QHash<mediaelch::scraper::MovieScraperInterface*, QString> m_ids;
