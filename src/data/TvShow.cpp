...
void TvShow::clear(QList<TvShowScraperInfos> infos)
{
...
QList<TvShowScraperInfos> TvShow::infosToLoad() const
{
...
QList<ImageType> TvShow::imageTypes()
{
...
QList<ImageType> TvShow::seasonImageTypes()
{
