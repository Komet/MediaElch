...
TmdbTvConfigurationView::TmdbTvConfigurationView(TmdbTvConfiguration& settings) : m_settings(settings)
{
    ...
    connect(&m_settings, &TmdbTvConfiguration::languageChanged, this, [this](Locale language) {
