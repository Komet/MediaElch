...
TheTvDbConfigurationView::TheTvDbConfigurationView(TheTvDbConfiguration& settings) : m_settings(settings)
{
    ...
    connect(&m_settings, &TheTvDbConfiguration::languageChanged, this, [this](Locale language) {
