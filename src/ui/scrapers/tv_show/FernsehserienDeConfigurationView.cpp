...
FernsehserienDeConfigurationView::FernsehserienDeConfigurationView(FernsehserienDeConfiguration& settings) :
    m_settings(settings)
{
    ...
    connect(&m_settings, &FernsehserienDeConfiguration::languageChanged, this, [this](Locale language) {
