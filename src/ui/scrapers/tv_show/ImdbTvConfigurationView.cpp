...
ImdbTvConfigurationView::ImdbTvConfigurationView(ImdbTvConfiguration& settings) : m_settings(settings)
{
    ...
    connect(&m_settings, &ImdbTvConfiguration::languageChanged, this, [this](Locale language) {
