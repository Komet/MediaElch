...
class TvMazeConfiguration : public QObject, public ScraperConfiguration
{
    Q_OBJECT
public:
    explicit TvMazeConfiguration(Settings& settings);
    ~TvMazeConfiguration() override = default;
