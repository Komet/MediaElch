...
commands:
   ...
   scraper     Test a scraper, e.g. search for movies or load one.
...
static int parseArguments(QApplication& app)
{
    ...
    case Command::Scraper: return mediaelch::cli::scraper(app, parser);
