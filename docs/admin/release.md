...
```sh
# Print all commits between the git tag v2.8.8 and the current master branch
git log --oneline v2.8.8..master
# Count the number of commits since the last version
git log --oneline v2.8.8..master | wc -l
```
...
## Update Git
 ...
 2. Add a version tag and push your changes
  ...
  - `git tag -a v2.8.8 -m "MediaElch Version 2.8.8"`
