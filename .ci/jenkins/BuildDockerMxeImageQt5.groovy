...
// Pipeline Script for Creating our MXE Docker Image for Qt5
//
...
pipeline {
  ...
  stages {
    ...
    stage('MediaElch Windows MXE Qt5 Build Image') {
      environment {
        IMAGE_NAME = 'mediaelch/mediaelch-ci-win:qt5'
        DOCKERFILE = 'Dockerfile.ci.qt5.windows'
      }
      steps {
        dir('.ci/docker') {
          script {
