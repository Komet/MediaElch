...
# Package script for macOS for Qt6.
...
print_important "Using Qt6 from \$HOME/Qt/6.5.2"
export PATH="$HOME/Qt/6.5.2/macos/bin/:$OLD_PATH"
...
mkdir -p "${PROJECT_DIR}/third_party/packaging_macOS_Qt6"
cd "${PROJECT_DIR}/third_party/packaging_macOS_Qt6"
...
cp ../../third_party/packaging_macOS_Qt6/ffmpeg MediaElch.app/Contents/MacOS/
cp ../../third_party/packaging_macOS_Qt6/libmediainfo.0.dylib MediaElch.app/Contents/MacOS/
...
../../third_party/packaging_macOS_Qt6/create-dmg/create-dmg \
	--volname "MediaElch" \
	...
	"MediaElch_macOS_Qt6_${ME_VERSION_NAME}.dmg" \
	MediaElch.app

# Move *.dmg into root directory
mv "MediaElch_macOS_Qt6_${ME_VERSION_NAME}.dmg" ../..

print_success "Successfully packaged MediaElch for macOS with Qt6"
print_success ".dmg can be found at:"
print_success "  $(pwd)/MediaElch_macOS_Qt6_${ME_VERSION_NAME}.dmg"
echo ""
