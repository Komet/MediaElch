...
class QJSONRPC_EXPORT QJsonObject
{
public:
    QJsonObject();
    ~QJsonObject();
...
private:
    ...
    friend QJSONRPC_EXPORT QDebug operator<<(QDebug, const QJsonObject &);
...
QJSONRPC_EXPORT QDebug operator<<(QDebug, const QJsonObject &);
#endif
